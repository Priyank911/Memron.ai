 ...
 */
function detectSignals(message, messageIndex) {
    const signals = [];
 ...
 */
function weightByRecency(signals, totalMessages) {
 ...
 */
export function detectOutcome(episode) {
    const allSignals = [];
 ...
 */
export function detectOutcomeFromMessages(messages) {
    const allSignals = [];
 ...
 */
export function getFinalUserSentiment(messages) {
 ...
 */
export function isSuccessfulConversation(messages) {
 ...
 */
export function getOutcomeExplanation(result) {
...
//# sourceMappingURL=outcome-detector.js.map